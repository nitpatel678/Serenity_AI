    ...
    <div className="w-full fixed top-0 z-50 bg-background/95 backdrop-blur">
      ...
      <header className="relative max-w-8xl mx-auto px-4">
        <div className="flex h-16 items-center justify-between">
          ...
          >
            <Leaf className="h-7 w-7 text-primary animate-pulse-gentle" />
            <div className="flex flex-col">
              <span className="text-lg font-bold bg-gradient-to-r from-primary to-primary/50 text-transparent bg-clip-text">
                SERENITY
              </span>
            </div>
          </Link>
            ...
            border-primary/10 ">
                <nav className="flex flex-col space-y-1 py-4">
                    {navItems.map((item)=>(
                        ...
                        href={item.href}
                        className="px-4 py-3 
                        text-sm font-medium text-muted-foreground hover:text-background 
